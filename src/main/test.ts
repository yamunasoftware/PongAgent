...
function testExecution(tests: Function[]): void {
...
function runTests(tests: Function[]): number[] {
...
function executeTest(test: Function, passed: number, failed: number): number[] {
  console.log("\nRunning " + test.name + "...");
