...
The application wrapper for the app was written in the React Framework in JavaScript. As mentioned before, the main functionality of the application is written in TypeScript, which is compiled into JavaScript. The application is also meant to be containerized using Docker and run on port 8080, on your compute instance. The container is compatible with all major container management platforms; therefore, the deployment process should be very straightforward.